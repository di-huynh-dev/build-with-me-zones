  ...
  (
    ...
    return (
      <Link href={`/blog/${slug}`} className="h-full block">
        <div
          ref={ref}
          className="group h-full flex flex-col rounded-xl overflow-hidden border border-primary/10 hover:border-primary/30 hover:shadow-lg transition-all duration-300 bg-background hover:bg-muted/50"
        >
